    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="space-y-6 text-lg text-zinc-300 leading-relaxed">
        ...
        <p>
          ...
          rengassarjat. Tarvittaessa etsimme autosi tietoihin, ajotapaan ja budjettiin sopivan
          vaihtoehdon, joten sinun ei tarvitse tietää valmiiksi oikeaa mallia tai edes tarkkaa
          rengasvaihtoehtoa. Autamme oikean koon ja sopivan rengastyypin valinnassa, jotta
          lopputulos toimii käytännössä eikä vain paperilla.
        </p>

        <p>
          Renkaiden myynnin lisäksi teemme kokonaisvaltaiset rengastyöt paikan päällä. Meiltä
          onnistuvat renkaiden vaihdot, kausivaihdot, vannetyöt, renkaiden asennukset vanteille,
        ...
        <p>
          ...
          katon alta, ota yhteyttä. Katsomme yhdessä autollesi sopivan ratkaisun ja kerromme
          selkeästi, mitä kannattaa tehdä ja mitä se käytännössä tarkoittaa. Kysy lisää
          puhelimitse, WhatsAppilla tai yhteydenoton kautta.
        </p>
      </div>
    </div>
  </div>
