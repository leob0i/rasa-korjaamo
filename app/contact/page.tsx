...
export default function ContactPage() {
  ...
  <div className="absolute inset-0 z-0">
    ...
    />
    <div className="absolute inset-0 bg-gradient-to-b from-zinc-900/50 via-zinc-900/35 to-zinc-900/70" />
  </div>
  ...
  <div className="flex items-center gap-3">
    <Link
      ...
      className="group inline-flex h-12 items-center gap-3 rounded-full bg-[#25D366] px-4 shadow-lg shadow-black/30 ring-1 ring-white/10 transition hover:bg-[#1EBE5D] hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/70"
    >
      <svg
        viewBox="0 0 32 32"
    ...
    <Link
      ...
      target="_blank"
      rel="noopener noreferrer"
      aria-label="Varaa aika"
      className="inline-flex h-12 items-center justify-center rounded-full bg-orange-600 px-6 text-sm font-semibold text-white shadow-lg shadow-black/30 ring-1 ring-white/10 transition hover:bg-orange-500 hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/70"
    >
      Varaa aika
    </Link>
  </div>
      ...
      <section className="pb-20 bg-zinc-900">
        <div className="container mx-auto px-4">
              ...
              <CardContent className="p-6 md:p-8">
                <div className="mb-8">
                  <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 text-balance">
                    Lähetä sähköpostia tai tiedostoja 
                  </h2>
                  <p className="text-zinc-300 leading-relaxed">
                    Jos asiasi koskee ajanvarausta, varaathan ajan yllä olevasta "Varaa aika" -painikkeesta. Muissa yhteydenotoissa, kuten rengaskyselyissä tai muissa asioissa, voit ottaa yhteyttä tällä lomakkeella, soittamalla tai WhatsAppin kautta.
                  </p>
                </div>

                <form
                  action="https://formsubmit.co/adrasavaananen@gmail.com"
                  method="POST"
                  encType="multipart/form-data"
                  className="space-y-6"
                >
                  <input type="hidden" name="_subject" value="Uusi yhteydenotto AD Rasa & Väänänen verkkosivulta" />
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full rounded-xl border border-zinc-700 bg-zinc-900 px-4 py-3 text-white placeholder:text-zinc-500 outline-none transition focus:border-orange-600"
                      />
                    </div>
                    ...
                    <div>
                      <label htmlFor="registration" className="block text-sm font-medium text-white mb-2">
                        Rekisterinumero
                      </label>
                      <input
                        id="registration"
                    ...
                    <div className="md:col-span-2">
                      <label htmlFor="kilometers" className="block text-sm font-medium text-white mb-2">
                        Kilometrit
                      </label>
                      <input
                        id="kilometers"
                    ...
                    <div className="md:col-span-2">
                      ...
                      <textarea
                        ...
                        className="w-full rounded-xl border border-zinc-700 bg-zinc-900 px-4 py-3 text-white placeholder:text-zinc-500 outline-none transition focus:border-orange-600 resize-y"
                      />
                    </div>
                    ...
                    <div className="md:col-span-2">
                      ...
                      <input
                        ...
                        className="block w-full rounded-xl border border-dashed border-zinc-700 bg-zinc-900 px-4 py-3 text-sm text-zinc-300 file:mr-4 file:rounded-full file:border-0 file:bg-orange-600 file:px-4 file:py-2 file:text-sm file:font-semibold file:text-white hover:file:bg-orange-500"
                      />
                      <p className="mt-2 text-sm text-zinc-400">
                        Sallitut tiedostot: kuva tai PDF. Suositeltu enimmäiskoko 2 MB.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col gap-3 pt-2">
                    ...
                    <button
                      type="submit"
                      className="inline-flex w-full md:w-auto items-center justify-center rounded-full bg-orange-600 px-6 py-3 text-sm font-semibold text-white transition hover:bg-orange-500"
                    >
                      Lähetä viesti
                    </button>
                  </div>
